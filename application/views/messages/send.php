          ...
          <?php echo form_open('messages/send', array('name'=>'sendMessageForm', 'class' => 'form-horizontal')); ?>
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type='text' name='recipient' value="<? echo $to?>" />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea name="message"><? echo set_value('message'); ?></textarea>
		...
		<div class="controls">
		  <label class="checkbox inline">
		    <input type='checkbox' name='burn_after_reading' value='1' />
              ...
              <textarea style="display:none;" name="pubkey"><? echo $publickey; ?></textarea><br />

              <div class="form-actions">
                <input type='submit' class="btn btn-primary" value="Send" onclick='messageEncrypt()' />
                <? echo anchor('messages', 'Cancel', 'class="btn"');?>
              </div>
            </fieldset>
          </form>
</div>
